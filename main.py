...
class Data(object):
    ...
    ms=pd.read_csv("../data/generatedData/Client1AllModelStates.csv")
...
class Ch3(object):
    ...
    def potentialSurface(
        ...
        plt.savefig("{0}/PotentialSurface{1}Effort{2}.png"
...
if __name__=="__main__":
    ...
    for i in range(5,11):
        for n,e in zip(
            ...
            print("Making potential surface for {0} at RPE {1}".format(n,i))
            Ch3.potentialSurface(liftName=n,
                liftId=e,
                date="05/06/2023",
                effort=i,
            )
