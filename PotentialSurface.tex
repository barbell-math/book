...
It needs to be shown that volume increases with effort and decreases with decreased effort. Changes in $v$ in relation to changes to $E$ is required. Solving for the partial derivative of equation \ref{eq:VolumeBaseIntensitySubedInVolume} with respect to $E$ is required.
